...
from vlmx_sh2.models.parser.filtering import ValueExpression, FilterCondition, LogicalOperator
from vlmx_sh2.enums import Operator
from vlmx_sh2.storage.filters import _evaluate_value_expression, _apply_operator
...
def main():
    """Run all tests."""
    print("Running comprehensive tests for value-level query operators & range support...\n")
