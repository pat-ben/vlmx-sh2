...
class Recognizer:
    ...
    @classmethod
    def recognize(
        cls, classified_tokens: List[ClassifiedToken], context: ValidationContext
    ...
    def _recognize_token(
        ...
        if classified_token.token_class == TokenClass.TEXT:
            ...
            return cls._recognize_text_token(
    ...
    def _is_schema_name_value(
        cls, token: ClassifiedToken, prev_token: RecognizedToken
    ) -> bool:
