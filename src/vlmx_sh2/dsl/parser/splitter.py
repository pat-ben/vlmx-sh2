...
def split(
    interpreted_tokens: List[InterpretedToken], context: ValidationContext
) -> SplitResult:
    """
    ...
    bracket_open_index, bracket_close_index = _find_bracket_positions(
...
def _find_bracket_positions(
    tokens: List[InterpretedToken], context: ValidationContext
