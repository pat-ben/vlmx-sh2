...
class ValidationIssue(BaseModel):
    ...
    token_text: Optional[str] = Field(
        default=None,
        description="The problematic token text (used for position resolution)",
    )

    # Structured diagnostics
    error_code: Optional[str] = Field(
        default=None,
        description="Structured error identifier like 'vlmx::tokenizer::empty_command'",
    )
    doc_link: Optional[str] = Field(
        default=None, description="URL to documentation about this error"
    )
