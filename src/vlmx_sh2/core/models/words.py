...
class ActionWord(BaseWord):
    ...
    IMPORTANT:
    - This model is part of the language/vocabulary layer.
    - It must remain pure data (serializable) and MUST NOT carry runtime callables.
      Handler dispatch happens in the engine router via `IRCommand.action_id`.
    """

    # aliases field removed - now inherited from BaseWord
    word_type: Literal[WordType.ACTION] = WordType.ACTION
    execution_type: ExecutionType = Field(
        default=ExecutionType.STANDARD,
        description="Type of execution for this action",
    )
